...
function sfc_plugin_help() {
	...
	$home = home_url('/');
	$sfc_help_base = __("
		<p>Để tích hợp Facebook bạn sẽ cần tạo 1 App Facebook. Nếu bạn đã tạo 1 ứng dụng thì điền App ID và App Secret key vào dưới đây.</p>
		<p><strong>Không tìm thấy key?</strong></p>
		<ol>
			<li>Các ứng dụng mà bạn đã tạo <a target='_blank' href='https://developers.facebook.com/apps'>Facebook Application List</a></li>
			<li>Chọn ứng dụng bạn dùng để tích hợp facebook vào wordpress sau đó copy App Id và App secret key và dán vào dưới.</li>
		</ol>

		<p><strong>Bạn chưa tạo ứng dụng?</strong></p>
		<ol>
			<li>Vào link sau để tạo 1 App: <a target='_blank' href='https://developers.facebook.com/apps'>Facebook Application Setup</a></li>
			<li>Sau khi tạo App, điền <strong>http://localhost/dummy/</strong> vào mục the Site URL trong phần website login.</li>
			<li>Bạn có thể lấy các API tại 
			<a target='_blank' href='https://developers.facebook.com/apps'>Facebook Application List</a> page.</li>
			<li>Chọn ứng dụng bạn dùng để tích hợp facebook vào wordpress sau đó copy App Id và App secret key ở đó dán vào khung dưới đây.</li>
		</ol>
	", 'sfc');
